...
class generate(Scene):
    def construct(self):
        ...
        #NN Bias 2
        dic = { "matrix":  {"values": [[x] for x in nn_bias_2]  , "scale": 0.3, "color": PURE_GREEN},
                "title":   {"string": "\\text{Bias (Layer 2)}"  , "scale": 0.3, "color": PURE_GREEN},
                "label_x": {"string": ""                        , "scale": 0.3, "color": PURE_GREEN, "value": ""},
                "label_y": {"string": ""                        , "scale": 0.3, "color": PURE_GREEN, "value": ""}
              }
        ...
        #animation
        nn_calculation(self, equal, group_1, WHITE, group_2, YELLOW, group_3, PURE_GREEN, 3)
        ...
        #nn output dropout
        dic = { "matrix":  {"values": nn_output_dropout[0]                   , "scale": 0.3, "color": WHITE},
                "title":   {"string": "\\text{Neural Network Output}"        , "scale": 0.3, "color": WHITE},
                "label_x": {"string": "Embedding Dimensions"                 , "scale": 0.3, "color": WHITE, "value": d_model},
                "label_y": {"string": "Tokens"                               , "scale": 0.3, "color": WHITE, "value": len(input)}
              }
