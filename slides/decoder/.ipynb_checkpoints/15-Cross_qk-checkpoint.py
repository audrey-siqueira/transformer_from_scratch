...
class generate(Scene):
    def construct(self):
        ...
        def split(position,p,arg_1,color_1,arg_2,color_2,arg_3,arg_4):
        ...
        split(position   = LEFT*0.2 + UP*6,
              p          = 1,
              arg_1      = cross_h_query[0][0],
              color_1    = BLUE_C,
              arg_2      = cross_h_key[0][0],
              color_2    = PURE_RED,
              arg_3      = cross_QK[0][0],
              arg_4      = cross_attention_scores_partial_original[0][0])
              #arg_5      = attention_scores[0][0])
        

        split(position   = LEFT*0.2 + DOWN*5,
              p          = 2,
              arg_1      = cross_h_query[0][1],
              color_1    = BLUE_C,
              arg_2      = cross_h_key[0][1],
              color_2    = PURE_RED,
              arg_3      = cross_QK[0][1],
              arg_4      = cross_attention_scores_partial_original[0][1])
