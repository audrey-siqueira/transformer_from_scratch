...
class generate(Scene):
    def construct(self):
        ...
        split(position   = LEFT*0.2 + UP*4,
              arg_1      = cross_attention_scores[0][0],
              arg_2      = cross_attention_scores_dropout[0][0],
              color_2    = WHITE,
              arg_3      = cross_h_value[0][0],
              color_3    = PURE_GREEN,
              arg_4      = cross_AV[0][0],
              order      = "1")

        split(position   = LEFT*0.2 + UP*12,
              arg_1      = cross_attention_scores[0][1],
              arg_2      = cross_attention_scores_dropout[0][1],
              color_2    = WHITE,
              arg_3      = cross_h_value[0][1],
              color_3    = PURE_GREEN,
              arg_4      = cross_AV[0][1],
              order      = "2")
