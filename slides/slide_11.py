...
class generate(Scene):
    def construct(self):
        ...
        #add
        dic = { "matrix":  {"values": add[0]                            ,"scale": 0.4, "color": WHITE},
                "title":   {"string": "\\text{Neural Network Input}"    , "scale": 0.4, "color": WHITE},
        ...
        #final input
        dic = { "matrix":  {"values": nn_normalized[0]                 ,"scale": 0.4, "color": WHITE},
                "title":   {"string": "\\text{Normalized Neural Network Input}"   , "scale": 0.4, "color": WHITE},
                "label_x": {"string": "Embedding Dimensions"           , "scale": 0.4, "color": WHITE, "value": d_model},
                "label_y": {"string": "Tokens"                  , "scale": 0.4, "color": WHITE, "value": len(input)}
              }
