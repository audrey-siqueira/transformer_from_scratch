...
class generate(Scene):
    def construct(self):
        self.camera.background_color = BLACK
         ...
         #final input
        dic = { "matrix":  {"values": nn_normalized[0]                 ,"scale": 0.3, "color": WHITE},
        ...
        #NN Bias 1
        dic = { "matrix":  {"values": [[x] for x in nn_bias_1]  , "scale": 0.3, "color": PURE_GREEN},
                "title":   {"string": "\\text{Bias (Layer 1)}"  , "scale": 0.3, "color": PURE_GREEN},
        ...
        #animation
        nn_calculation(self, equal, group_1, WHITE, group_2, YELLOW, group_3, PURE_GREEN, 1.6)
