...
class generate(Scene):
    def construct(self):
        ...
        #output_dropout
        dic = { "matrix":  {"values": layer_output_dropout[0]  , "scale": 0.3, "color": WHITE},
        ...
        #total input dropout
        dic = { "matrix":  {"values": sum_dropout[0]                , "scale": 0.3, "color": WHITE},
                "title":   {"string": "\\text{Total Input}"         , "scale": 0.3, "color": WHITE},
                "label_x": {"string": "Embedding Dimensions"        , "scale": 0.3, "color": WHITE, "value": d_model},
                "label_y": {"string": "Tokens"                      , "scale": 0.3, "color": WHITE, "value": len(input)}
              }
        ...
        #add
        dic = { "matrix":  {"values": add[0]                                 , "scale": 0.3, "color": WHITE},
